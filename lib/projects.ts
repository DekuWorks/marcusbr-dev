...
export const FEATURED_PROJECTS: FeaturedProject[] = [
  ...
  },
  {
    ...
    developmentFocus:
      "iOS 1.0.1 (build 158) submitted to App Store Connect with new brand icon — TestFlight processing and review follow-through next.",
    trackerPhase: "App Store Connect",
    trackerProgress: 95,
    trackerDetail:
      "ASC upload complete — Apple processing build 158; preview 160 installable.",
    lessonsLearned:
