...
export const SITE_DESCRIPTION =
  "Marcus Brown is a Senior Full Stack Developer and AI Engineer with 8+ years building SaaS platforms, native and cross-platform mobile apps, secure APIs, and AI-assisted product experiences with React, TypeScript, Swift/SwiftUI, Flutter, React Native, .NET, Python/FastAPI, Rails, Supabase, Azure, and AWS.";
